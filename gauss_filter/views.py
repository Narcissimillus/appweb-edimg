...
def gauss_filt_3x3():
    if request.method == "POST":
        try:
            ...
            im_gauss.save('static/uploads/img_gauss_3x3.jpg')
            image_url_gauss = url_for('static',filename="uploads/img_gauss_3x3.jpg")
...
def gauss_filt_5x5():
    if request.method == "POST":
        try:
            ...
            im_gauss.save('static/uploads/img_gauss_5x5.jpg')
            image_url_gauss = url_for('static',filename="uploads/img_gauss_5x5.jpg")
