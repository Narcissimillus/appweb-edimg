...
def artm_filter():
    if request.method == "POST":
        try:
            ...
            im_artm.save('static/uploads/img_artm.jpg')
            image_url_artm = url_for('static',filename="uploads/img_artm.jpg")
...
def geom_filter():
    if request.method == "POST":
        try:
            ...
            im_geom.save('static/uploads/img_geom.jpg')
            image_url_geom = url_for('static',filename="uploads/img_geom.jpg")
...
def harm_filter():
    if request.method == "POST":
        try:
            ...
            im_harm.save('static/uploads/img_harm.jpg')
            image_url_harm = url_for('static',filename="uploads/img_harm.jpg")
...
def alphach_filter():
    if request.method == "POST":
        try:
            ...
            imgname = 'img_alphach_' + str(alpha) + '.jpg'
...
def alphapow_filter():
    if request.method == "POST":
        try:
            ...
            im = Image.open(image_src)
            alpha = int(request.get_data())
            imgname = 'img_alphapow_' + str(alpha) + '.jpg'
...
def alphapow2_filter():
    if request.method == "POST":
        try:
            ...
            alpha = int(request.get_data())
            print(alpha)
            imgname = 'img_alphapow2_' + str(alpha) + '.jpg'
