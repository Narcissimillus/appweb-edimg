...
def min_filter():
    if request.method == "POST":
        try:
            ...
            im_min.save('static/uploads/img_min.jpg')
            image_url_min = url_for('static',filename="uploads/img_min.jpg")
...
def max_filter():
    if request.method == "POST":
        try:
            ...
            im_max.save('static/uploads/img_max.jpg')
            image_url_max = url_for('static',filename="uploads/img_max.jpg")
...
def median_filter():
    if request.method == "POST":
        try:
            ...
            im_median.save('static/uploads/img_median.jpg')
            image_url_median = url_for('static',filename="uploads/img_median.jpg")
...
def range_filter():
    if request.method == "POST":
        try:
            ...
            im_range.save('static/uploads/img_range.jpg')
            image_url_range = url_for('static',filename="uploads/img_range.jpg")
...
def alphamed_filter():
    if request.method == "POST":
        try:
            ...
            imgname = 'img_alphamed_' + str(alpha) + '.jpg'
            if alpha == 1:
...
def alphacom_filter():
    if request.method == "POST":
        try:
            ...
            im = Image.open(image_src)
            alpha = int(request.get_data())
            imgname = 'img_alphacom_' + str(alpha) + '.jpg'
            if alpha == 1:
...
def alphaqsr_filter():
    if request.method == "POST":
        try:
            ...
            im = Image.open(image_src)
            alpha = int(request.get_data())
            imgname = 'img_alphaqsr_' + str(alpha) + '.jpg'
            if alpha == 1:
